...
app.get('/weather/default', (req, res) => {
   ...
   const longitude = 20.3816501;
    ...
    currentForecast(latitude, longitude, (error, {
        temperature,
        feelslike,
        pressure,
        weatherDescription,
        ...
        airpollution(latitude, longitude, (error, {
            co,
            no,
            no2,
            o3,
...
app.post('/weather/geolocation', (req, res) => {
    ...
    currentForecast(req.body.latitude, req.body.longitude, (error, {
        temperature,
        feelslike,
        pressure,
        weatherDescription,
        ...
        airpollution(req.body.latitude, req.body.longitude, (error, {
            co,
            no,
            no2,
            o3,
            ...
            fiveDayForecast(req.body.latitude, req.body.longitude, (error, fiveDayForecast) => {
                if (error) {
                    return res.send(error)
                }
...
app.get('/weather', (req, res) => {
    ...
    if (!req.query.address) {
    ...
    } else { //ukinuti kasnije obj destructuring
        geocode(req.query.address, (error, {
            ...
            //ukinuti kasnije obj destructuring
            currentForecast(longitude, latitude, (error, {
                temperature,
                feelslike,
                pressure,
                weatherDescription,
                ...
                airpollution(longitude, latitude, (error, {
                    co,
                    no,
                    no2,
                    o3,
                    ...
                    fiveDayForecast(longitude, latitude, (error, fiveDayForecast) => {
                        if (error) {
                            return res.send(error)
                        }
...
app.get('/help/*', (req, res) => {
    res.render('404', {
        title: '404',
        error: 'This hepl article not found',
        name: 'John Doe'
    })
})
